...
- [x] 87. 全文预览更激进：剥离“纯文本 URL 段落/条目”（绕过 `<a>` 的链接噪音也能清掉），保留视频站点白名单
- [x] 88. 全文预览排版微调：H4 “胶囊标题”仅在目录模式启用，文章模式回归正常标题（观感更像文章）
- [x] 89. 全文预览去壳补强：移除 ANN 常见的 `Disclosure:` 免责声明段落（减少正文尾部噪音）
- [x] 90. 全文预览图片观感：降低正文图片最大高度与阴影强度，手机端取消大阴影（减少“图墙压迫感”）
- [x] 91. 首屏性能再优化：已读状态 DOM 打标延后到 idle（避免列表页打开时“卡一下”）
